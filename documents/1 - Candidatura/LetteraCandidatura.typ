...
#page()[
  #box(height: 120pt)[
    ...
    #box(height: 10pt)[
      ...
      #place(center + horizon)[
        #block[
          #link("https://github.com/Archi7echs-Team/docs/tree/master")[https://github.com/Archi7echs-Team/docs/tree/master]
        ]
      ]
    ]
...
#box(height: 40pt)[
      ...
      #place(left + horizon)[
        #block[
          #text()[Rimaniamo a disposizione per ogni eventuale chiarimento.]\
          #text()[Si coglie l’occasione per porgere cordiali saluti]
        ]
      ]
    ]
