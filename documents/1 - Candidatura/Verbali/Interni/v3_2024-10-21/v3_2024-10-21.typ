...
#page(background: align(bottom + right, image("//img/logounipd.png", width: 70%)))[
  ...
  #figure(
    ...
    [#table(
      ...
      [#strong[Ultima Modifica:] 29/10/2024 16:46],
...
#align(center)[
  #figure[
    #table(
        ...
        [1.0], [21/10/2024], [Prima stesura documento], [Francesco Pozzobon], [-], [-],
    )
    <tab:my_label>
  ]
]
...
#par()[
  ...
  è quello di ottenere maggiori dettagli circa il progetto proposto e sulle tecnologie che
  si dovranno utilizzare. Leonardo Lucato si propone per tenere nota in un documento
  di quanto emerso dalla discussione del team al fine di poter formulare le domande nel
  miglior modo possibile, per sfruttare al meglio l’opportunità offertaci da Azzurrodigitale, senza sforare i 30min di chiamata prefissati.
