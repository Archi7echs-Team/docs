...
#page(background: align(bottom + right, image("//img/logounipd.png", width: 70%)))[
  ...
  #figure(
    ...
    [#table(
      ...
      [#strong[Ultima Modifica:] 29/10/2024 16:55],
...
#align(center)[
  #figure[
    #table(
        ...
        [1.0], [25/10/2024], [Prima stesura documento], [Francesco Pozzobon], [-], [-],
...
#par()[
  #set list(indent: 12pt)
  #v(1em)
  Letto nuovamente il capitolato dell’azienda e la risposta alla mail inviata il 17/10/2024 contenenente una serie di domande già poste (rif. Verbale Interno nr. 2 e Allegato 1, risposta dell'azienda)  si procede ad una discussione di gruppo per
  predisporre un elenco di domande da chiedere all’azienda durante la call. L’obiettivo
  è quello di ottenere maggiori dettagli circa il progetto proposto e sulla gestione dei dati che l'applicativo utilizzerà per realizzare i grafici, chiedendo inoltre un consiglio, come fatto con Azzurrodigitale, sui tool da utilizzare per la gestione del progetto. Gabriele Checchinato e Giovanni Salvò si propongono per tenere nota in un documento di quanto emerso dalla discussione del team al fine di poter formulare al meglio le domande qui sotto riportate:
...
#par()[
  ...
  - Dubbi ed incertezze
   ...
   - I diari di borso fanno parte della documentazione del progetto?
...
#par()[
  #v(1em)
  Gioele Scandaletti illustra la bozza di sito del team che ha realizzato con Github pages, raggiungibile all'indirizzo https://archi7echs-team.github.io/. L'obiettivo è quello di raccogliere in una pagina web intuitiva tutti i puntatori ai documenti redatti durante il progetto. I pareri sul lavoro fatto sono ottimi, Gioele comunica che dovrà sistemare solo la parte mobile.
